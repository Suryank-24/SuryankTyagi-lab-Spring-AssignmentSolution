...
<body>
	...
	<div class="container">
		...
		<p class="h4 mb-4">Enter Student Info</p>

		<form action="/studentFest/students/save" method="POST" autocomplete="off">
...
<hr>
		<a href="/studentFest/students/list">Back to Students List</a>
